...
describe('v1.SqlFlagsServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = sqlflagsserviceModule.v1.SqlFlagsServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = sqlflagsserviceModule.v1.SqlFlagsServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });
