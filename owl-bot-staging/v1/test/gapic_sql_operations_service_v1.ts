...
describe('v1.SqlOperationsServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = sqloperationsserviceModule.v1.SqlOperationsServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = sqloperationsserviceModule.v1.SqlOperationsServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = sqloperationsserviceModule.v1.SqlOperationsServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new sqloperationsserviceModule.v1.SqlOperationsServiceClient();
        assert(client);
    });
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.sql.v1.SqlOperationsGetRequest());
            request.project = '';
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.sql.v1.OperationsListResponse());
        ...
        it('invokes list without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.list(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.sql.v1.IOperationsListResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
