...
describe('v1.SqlConnectServiceClient', () => {
    ...
    describe('getConnectSettings', () => {
        it('invokes getConnectSettings without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.sql.v1.GetConnectSettingsRequest());
            request.project = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.sql.v1.ConnectSettings());
            ...
            assert((client.innerApiCalls.getConnectSettings as SinonStub)
    ...
    describe('generateEphemeralCert', () => {
        it('invokes generateEphemeralCert without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.sql.v1.GenerateEphemeralCertResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.generateEphemeralCert as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
