...
export class SqlOperationsServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.sql.v1.SqlOperationsService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.sqlOperationsServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.sql.v1.SqlOperationsService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.sql.v1.SqlOperationsService,
  ...
  get(
      ...
      Promise<[
        ...
        protos.google.cloud.sql.v1.ISqlOperationsGetRequest|undefined, {}|undefined
      ]>;
  get(
      request: protos.google.cloud.sql.v1.ISqlOperationsGetRequest,
      options: CallOptions,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [OperationsListResponse]{@link google.cloud.sql.v1.OperationsListResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
