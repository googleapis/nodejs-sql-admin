...
function main() {
  // [START sqladmin_v1_generated_SqlInstancesService_RescheduleMaintenance_async]
  /**
  ...
  async function rescheduleMaintenance() {
    // Construct request
    const request = {
    };
  ...
  // [END sqladmin_v1_generated_SqlInstancesService_RescheduleMaintenance_async]
}
