...
describe('v1beta4.SqlSslCertsServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = sqlsslcertsserviceModule.v1beta4.SqlSslCertsServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = sqlsslcertsserviceModule.v1beta4.SqlSslCertsServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = sqlsslcertsserviceModule.v1beta4.SqlSslCertsServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new sqlsslcertsserviceModule.v1beta4.SqlSslCertsServiceClient();
        assert(client);
    });
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.sql.v1beta4.SqlSslCertsDeleteRequest());
            request.project = '';
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.sql.v1beta4.SslCertsInsertResponse());
        ...
        it('invokes insert without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.insert(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.sql.v1beta4.ISslCertsInsertResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.sql.v1beta4.SqlSslCertsListRequest());
            request.project = '';
            const expectedHeaderRequestParams = "project=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.sql.v1beta4.SslCertsListResponse());
        ...
        it('invokes list without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.list(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.sql.v1beta4.ISslCertsListResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
