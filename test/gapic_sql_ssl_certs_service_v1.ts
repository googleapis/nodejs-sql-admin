...
describe('v1.SqlSslCertsServiceClient', () => {
  it('has servicePath', () => {
    const servicePath =
      sqlsslcertsserviceModule.v1.SqlSslCertsServiceClient.servicePath;
    assert(servicePath);
  });

  it('has apiEndpoint', () => {
    const apiEndpoint =
      sqlsslcertsserviceModule.v1.SqlSslCertsServiceClient.apiEndpoint;
    assert(apiEndpoint);
  });
    ...
    it('invokes insert without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.insert(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.sql.v1.ISslCertsInsertResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes list without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.list(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.sql.v1.ISslCertsListResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
