...
describe('v1beta4.SqlUsersServiceClient', () => {
  it('has servicePath', () => {
    const servicePath =
      sqlusersserviceModule.v1beta4.SqlUsersServiceClient.servicePath;
    assert(servicePath);
  });

  it('has apiEndpoint', () => {
    const apiEndpoint =
      sqlusersserviceModule.v1beta4.SqlUsersServiceClient.apiEndpoint;
    assert(apiEndpoint);
  });
  ...
  describe('delete', () => {
    it('invokes delete without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.sql.v1beta4.SqlUsersDeleteRequest()
      );
      request.project = '';
  ...
  describe('insert', () => {
    it('invokes insert without error', async () => {
      ...
      client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.sql.v1beta4.SqlUsersInsertRequest()
      );
      request.project = '';
      const expectedHeaderRequestParams = 'project=';
      const expectedOptions = {
  ...
  describe('list', () => {
    it('invokes list without error', async () => {
      ...
      client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.sql.v1beta4.SqlUsersListRequest()
      );
      request.project = '';
      const expectedHeaderRequestParams = 'project=';
      const expectedOptions = {
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.sql.v1beta4.UsersListResponse()
      );
    ...
    it('invokes list without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.list(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.sql.v1beta4.IUsersListResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('update', () => {
    it('invokes update without error', async () => {
      ...
      client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.sql.v1beta4.SqlUsersUpdateRequest()
      );
      request.project = '';
      const expectedHeaderRequestParams = 'project=';
      const expectedOptions = {
