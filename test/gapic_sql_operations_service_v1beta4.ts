...
describe('v1beta4.SqlOperationsServiceClient', () => {
  it('has servicePath', () => {
    const servicePath =
      sqloperationsserviceModule.v1beta4.SqlOperationsServiceClient.servicePath;
    assert(servicePath);
  });

  it('has apiEndpoint', () => {
    const apiEndpoint =
      sqloperationsserviceModule.v1beta4.SqlOperationsServiceClient.apiEndpoint;
    assert(apiEndpoint);
  });

  it('has port', () => {
    const port =
      sqloperationsserviceModule.v1beta4.SqlOperationsServiceClient.port;
    assert(port);
  ...
  it('should create a client with no option', () => {
    const client =
      new sqloperationsserviceModule.v1beta4.SqlOperationsServiceClient();
    assert(client);
  });
    ...
    it('invokes list without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.list(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.sql.v1beta4.IOperationsListResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
