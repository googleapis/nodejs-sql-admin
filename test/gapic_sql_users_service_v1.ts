...
describe('v1.SqlUsersServiceClient', () => {
  it('has servicePath', () => {
    const servicePath =
      sqlusersserviceModule.v1.SqlUsersServiceClient.servicePath;
    assert(servicePath);
  });

  it('has apiEndpoint', () => {
    const apiEndpoint =
      sqlusersserviceModule.v1.SqlUsersServiceClient.apiEndpoint;
    assert(apiEndpoint);
  });
    ...
    it('invokes list without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.list(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.sql.v1.IUsersListResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
