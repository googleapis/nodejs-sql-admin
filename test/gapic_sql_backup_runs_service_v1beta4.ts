...
describe('v1beta4.SqlBackupRunsServiceClient', () => {
  it('has servicePath', () => {
    const servicePath =
      sqlbackuprunsserviceModule.v1beta4.SqlBackupRunsServiceClient.servicePath;
    assert(servicePath);
  });

  it('has apiEndpoint', () => {
    const apiEndpoint =
      sqlbackuprunsserviceModule.v1beta4.SqlBackupRunsServiceClient.apiEndpoint;
    assert(apiEndpoint);
  });

  it('has port', () => {
    const port =
      sqlbackuprunsserviceModule.v1beta4.SqlBackupRunsServiceClient.port;
    assert(port);
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.sql.v1beta4.IBackupRun | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes list without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.list(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.sql.v1beta4.IBackupRunsListResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
