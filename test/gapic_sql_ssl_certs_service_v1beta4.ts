...
describe('v1beta4.SqlSslCertsServiceClient', () => {
  it('has servicePath', () => {
    const servicePath =
      sqlsslcertsserviceModule.v1beta4.SqlSslCertsServiceClient.servicePath;
    assert(servicePath);
  });

  it('has apiEndpoint', () => {
    const apiEndpoint =
      sqlsslcertsserviceModule.v1beta4.SqlSslCertsServiceClient.apiEndpoint;
    assert(apiEndpoint);
  });
  ...
  describe('delete', () => {
    it('invokes delete without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.sql.v1beta4.SqlSslCertsDeleteRequest()
      );
      request.project = '';
  ...
  describe('get', () => {
    it('invokes get without error', async () => {
      ...
      client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.sql.v1beta4.SqlSslCertsGetRequest()
      );
      request.project = '';
      const expectedHeaderRequestParams = 'project=';
      const expectedOptions = {
  ...
  describe('insert', () => {
    it('invokes insert without error', async () => {
      ...
      client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.sql.v1beta4.SqlSslCertsInsertRequest()
      );
      request.project = '';
      const expectedHeaderRequestParams = 'project=';
      const expectedOptions = {
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.sql.v1beta4.SslCertsInsertResponse()
      );
    ...
    it('invokes insert without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.insert(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.sql.v1beta4.ISslCertsInsertResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('list', () => {
    it('invokes list without error', async () => {
      ...
      client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.sql.v1beta4.SqlSslCertsListRequest()
      );
      request.project = '';
      const expectedHeaderRequestParams = 'project=';
      const expectedOptions = {
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.sql.v1beta4.SslCertsListResponse()
      );
    ...
    it('invokes list without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.list(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.sql.v1beta4.ISslCertsListResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
