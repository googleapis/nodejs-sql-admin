...
# [Cloud SQL Admin API: Node.js Client](https://github.com/googleapis/nodejs-sql-admin)
...
* [github.com/googleapis/nodejs-sql-admin](https://github.com/googleapis/nodejs-sql-admin)
...
```bash
npm install @google-cloud/sql-admin
```
...
const {SqlUsersServiceClient} = require('@google-cloud/sql-admin');
...
const client = new {SqlUsersServiceClient}();
...
[enable_api]: https://console.cloud.google.com/flows/enableapi?apiid=sql.googleapis.com
